    ...
    <input type="text" placeholder="Name" name="fullname" value="<?php if (isset($fullname))
{
    ...
    <br>
    <input type="radio" checked="checked" name="gender" value="A"><a style="color:#555;font-size: 20px;";>♂</a>
    <input type="radio" name="gender" value="B"><a style="color:pink;font-size: 20px;";>♀</a>
    <input type="radio" name="gender" value="C"><a style="color:#555;font-size: 20px;";>⚥</a>
    <br>
